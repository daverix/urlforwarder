...
class FiltersActivityTest {
    @get:Rule
    val testRule = ActivityScenarioRule(FiltersActivity::class.java)
    ...
    private fun verifyEditTextFieldsMatch(
            filterName: String,
            filter: String,
    ...
    private fun checkFilterNameNotInList(filterName: String) {
        onView(withId(R.id.list))
                ...
                .check(matches(IsNot.not(hasDescendant(withText(filterName)))))
    }
}